    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative transition-colors">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-3 text-center text-slate-600 dark:text-slate-400">
          ...
          <Link to="/login" className="font-bold text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors underline underline-offset-4 decoration-2 decoration-blue-200 dark:decoration-blue-800 hover:decoration-blue-600 dark:hover:decoration-blue-400">
            Sign in
          </Link>
        </p>
      </div>
